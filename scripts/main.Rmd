...
library(ggpubr, lib.loc = "/mnt/users/reich/programs/R/lib")
...
for(disease in 1:length(disease_vector)) {
  ...
  if (SAVE.files ==TRUE ){
    filename.volcano <-paste0("../output/plots/de_analysis/", Sys.Date(), "_de_volcano_DISEASE_", disease_vector[disease], ".svg")
  ...
  ggplot(data=de.results, aes(x=log2FoldChange, y=-log10(padj), col=research_mirna, label=delabel)) + 
    ...
    if (SAVE.files ==TRUE ){
      filename.volcano2 <-paste0("../output/plots/de_analysis/", Sys.Date(), "_de_volcano_DISEASE_", disease_vector[disease], "_LITERATmiRNAs_ANNOT.svg")
  ...
  if(!is.null(migwas_mirna_results)) {
    ...
    print(volcano_3)
    if (SAVE.files ==TRUE ){
      filename.volcano3 <-paste0("../output/plots/de_analysis/", Sys.Date(), "_de_volcano_DISEASE_", disease_vector[disease], "_MIGWAS_ANNOT.svg")
    ...
    if (SAVE.files ==TRUE ){
      filename.volcanos.arranged.png <-paste0("../output/plots/de_analysis/", Sys.Date(), "_de_volcano_DISEASE_", disease_vector[disease], "_arranged.png")
      filename.volcanos.arranged.svg <-paste0("../output/plots/de_analysis/", Sys.Date(), "_de_volcano_DISEASE_", disease_vector[disease], "_arranged.svg")
    ...
    if (SAVE.files ==TRUE ){
      filename.volcano_frey <-paste0("../output/plots/de_analysis/", 
